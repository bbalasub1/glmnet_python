...
CV for multi-variate gaussian, cox and poisson models are yet to be implemented. Further, all CV is done serially. Parallel versions are yet to be implemented.
